Algoritmo SistemaGestionEmpresa
	...
	repetir
		...
		Segun OP hacer
			...
			De Otro Modo:
				Escribir "Opci�n inv�lida. Ingrese nuevamente."
		Fin Segun
	hasta que opcion = 6
...
Funcion RegistrarUsuario(matriz, cont)
	...
	Escribir "Ingrese el n�mero del perfil (1:cliente2, 2:profesional, 3:administrativo)"
	Leer perfil
	
	Segun perfil Hacer	
		1:
			matriz[cont, 4] = "cliente2";
			Escribir "Ingrese la direcci�n del cliente2:";
			Leer direccion;
			matriz[cont, 5] = direccion;	
			Escribir "Ingrese el tel�fono del cliente2:";
			Leer telefono;
	...
	Para i = 1 hasta cont hacer
		Si matriz[i, 1] <> "" entonces
			...
			Segun matriz[i, 4] Hacer
				"cliente2":
					Escribir "Direcci�n: ", matriz[i, 5]
					Escribir "Tel�fono: ", matriz[i, 6]
					Escribir "Cantidad de empleados: ", matriz[i, 7]
				"profesional":
					Escribir "A�os de experiencia: ", matriz[i, 5]
					Escribir "Departamento: ", matriz[i, 6]
				"administrativo":
					Escribir "Funci�n: ", matriz[i, 5]
...
Funcion ContarUsuariosCategoria(matriz, cont)
	...
	Escribir "----- USUARIOS POR CATEGOR�A -----"
...
Funcion ModificarUsuario(matriz, cont)
	...
	Para i = 1 hasta cont hacer
		Si matriz[i, 3] = runModificar entonces
			id_usuario = i;
			Escribir "Usuario ",matriz[id_usuario, 1]," ser� modificado, por favor ingrese los nuevos datos:";
			...
			Escribir "Usuario registrado exitosamente.";
		SiNo
			Escribir "No se encontr� ning�n usuario con el RUN especificado.";
		FinSi
	FinPara
FinFuncion
